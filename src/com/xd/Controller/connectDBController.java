...
import com.xd.entity.Data;
import com.xd.entity.DatabaseInfo;
import com.xd.entity.Head;
import com.xd.entity.Table;
...
public class connectDBController {
    ...
    public String get_conn(DatabaseInfo databaseInfo, HttpServletRequest request, HttpServletResponse response) throws IOException,SQLException{
...
//        conn(dburl,databaseInfo,request,response);
    ...
    //sql_server数据库
    private String to_sql_server(DatabaseInfo databaseInfo,HttpServletRequest request, HttpServletResponse response)throws SQLException{
        try {
...
//            System.exit(-1);
    ...
    //oracle数据库
    private String to_oracle(DatabaseInfo databaseInfo,HttpServletRequest request, HttpServletResponse response)throws SQLException{
        try {
...
//            System.exit(-1);
    ...
    //mysql数据库
    private String to_mysql(DatabaseInfo databaseInfo,HttpServletRequest request, HttpServletResponse response) throws SQLException{
...
//         com.mysql.jdbc.Driver driver = new com.mysql.jdbc.Driver();
    ...
    //不同数据库的公共部分，获取表
    private void conn(String dburl,DatabaseInfo databaseInfo,HttpServletRequest request, HttpServletResponse response)throws SQLException{
...
//        return "getdata";
    ...
    public String getData(String tableName,HttpServletRequest request, HttpServletResponse response) throws IOException ,SQLException{
        ResultSet re = databaseMetaData.getColumns(
                catalog, schemaPattern,  tableName, null);
